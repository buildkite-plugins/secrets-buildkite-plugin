...
# Defaulting to base plugin values in order to not break backwards compatibility
  ...
  [[ -n "${BUILDKITE_PLUGIN_SECRETS_GIT_CREDENTIALS:-}" ]] && export BUILDKITE_PLUGIN_SECRETS_GIT_CREDENTIALS
  [[ -n "${BUILDKITE_PLUGIN_SECRETS_GIT_CREDENTIALS_FILE:-}" ]] && export BUILDKITE_PLUGIN_SECRETS_GIT_CREDENTIALS_FILE
  [[ -n "${BUILDKITE_PLUGIN_SECRETS_GIT_SSH_KEY:-}" ]] && export BUILDKITE_PLUGIN_SECRETS_GIT_SSH_KEY
  [[ -n "${BUILDKITE_PLUGIN_SECRETS_GIT_SSH_KNOWN_HOSTS:-}" ]] && export BUILDKITE_PLUGIN_SECRETS_GIT_SSH_KNOWN_HOSTS
